<!-- title: Tenant Foundation Technical Contract -->
<!-- status: Active -->
<!-- system: TM-EPOS MVP Unified Commerce Scope -->
<!-- last_updated: 2026-06-29 -->

# Tenant Foundation Technical Contract

## Purpose

Defines the implementation contract for `Tenant_Foundation`. This contract is based on
...
- [[04_MODULE_KNOWLEDGE/02_Tenant_Foundation/01_Module_Overview]]
