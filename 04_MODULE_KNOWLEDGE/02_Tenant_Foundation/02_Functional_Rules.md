<!-- title: Tenant Foundation Functional Rules -->
<!-- status: Active -->
<!-- system: OneVerz POS MVP Unified Commerce Scope -->
<!-- last_updated: 2026-06-29 -->

# Tenant Foundation Functional Rules

## Purpose

Defines business and UX rules for `Tenant_Foundation` in the new OneVerz POS MVP scope.
