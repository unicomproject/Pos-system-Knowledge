<!-- title: Customer Basic, Authentication & Consent Functional Rules -->
<!-- status: Active -->
<!-- system: OneVerz POS MVP Unified Commerce Scope -->
<!-- last_updated: 2026-06-29 -->

# Customer Basic, Authentication & Consent Functional Rules

## Purpose

Defines business and UX rules for `Customer_Account_Consent` in the new OneVerz POS MVP scope.
