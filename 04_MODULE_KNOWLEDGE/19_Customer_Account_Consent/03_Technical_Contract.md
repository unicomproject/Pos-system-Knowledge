<!-- title: Customer Basic, Authentication & Consent Technical Contract -->
<!-- status: Active -->
<!-- system: TM-EPOS MVP Unified Commerce Scope -->
<!-- last_updated: 2026-06-29 -->

# Customer Basic, Authentication & Consent Technical Contract

## Purpose

Defines the implementation contract for `Customer_Account_Consent`. This contract is based on
...
| API Group | Purpose |
|---|---|
| `/api/v1/customers` | Module API group |
| `/api/v1/customer-auth` | Module API group |
| `/api/v1/customer-auth/otp` | Module API group |
| `/api/v1/customer-consents` | Module API group |
