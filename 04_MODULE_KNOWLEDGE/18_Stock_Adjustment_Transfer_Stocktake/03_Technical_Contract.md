<!-- title: Stock Adjustment, Transfer & Stocktake Technical Contract -->
<!-- status: Active -->
<!-- system: TM-EPOS MVP Unified Commerce Scope -->
<!-- last_updated: 2026-06-29 -->

# Stock Adjustment, Transfer & Stocktake Technical Contract

## Purpose

Defines the implementation contract for `Stock_Adjustment_Transfer_Stocktake`. This contract is based on
...
| API Group | Purpose |
|---|---|
| `/api/v1/inventory/adjustments` | Module API group |
| `/api/v1/inventory/transfers` | Module API group |
| `/api/v1/inventory/stocktakes` | Module API group |
