<!-- title: Stock Adjustment, Transfer & Stocktake Functional Rules -->
<!-- status: Active -->
<!-- system: OneVerz POS MVP Unified Commerce Scope -->
<!-- last_updated: 2026-06-29 -->

# Stock Adjustment, Transfer & Stocktake Functional Rules

## Purpose

Defines business and UX rules for `Stock_Adjustment_Transfer_Stocktake` in the new OneVerz POS MVP scope.
