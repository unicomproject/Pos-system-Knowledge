<!-- title: Invitations, Authentication, Tokens & Security Audit Functional Rules -->
<!-- status: Active -->
<!-- system: OneVerz POS MVP Unified Commerce Scope -->
<!-- last_updated: 2026-06-29 -->

# Invitations, Authentication, Tokens & Security Audit Functional Rules

## Purpose

Defines business and UX rules for `Auth_Tokens_Security_Audit` in the new OneVerz POS MVP scope.
