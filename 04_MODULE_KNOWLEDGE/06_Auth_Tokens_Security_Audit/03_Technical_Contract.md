<!-- title: Invitations, Authentication, Tokens & Security Audit Technical Contract -->
<!-- status: Active -->
<!-- system: TM-EPOS MVP Unified Commerce Scope -->
<!-- last_updated: 2026-06-29 -->

# Invitations, Authentication, Tokens & Security Audit Technical Contract

## Purpose

Defines the implementation contract for `Auth_Tokens_Security_Audit`. This contract is based on
...
| API Group | Purpose |
|---|---|
| `/api/v1/auth/login` | Module API group |
| `/api/v1/auth/refresh` | Module API group |
| `/api/v1/auth/logout` | Module API group |
| `/api/v1/invitations` | Module API group |
| `/api/v1/password-reset` | Module API group |
...
- [[04_MODULE_KNOWLEDGE/06_Auth_Tokens_Security_Audit/01_Module_Overview]]
