...
| API Group | Purpose |
|---|---|
| `/api/v1/products/{id}/images` | Module API group |
| `/api/v1/products/{id}/barcodes` | Module API group |
| `/api/v1/product-attributes` | Module API group |
| `/api/v1/product-channel-visibility` | Module API group |
