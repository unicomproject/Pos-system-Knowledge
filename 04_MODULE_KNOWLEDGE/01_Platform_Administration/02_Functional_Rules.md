<!-- title: Platform Administration Functional Rules -->
<!-- status: Active -->
<!-- system: OneVerz POS MVP Unified Commerce Scope -->
<!-- last_updated: 2026-06-29 -->

# Platform Administration Functional Rules

## Purpose

Defines business and UX rules for `Platform_Administration` in the new OneVerz POS MVP scope.
