<!-- title: Subscription Catalog, Plans, Add-ons & Entitlements Technical Contract -->
<!-- status: Active -->
<!-- system: TM-EPOS MVP Unified Commerce Scope -->
<!-- last_updated: 2026-06-29 -->

# Subscription Catalog, Plans, Add-ons & Entitlements Technical Contract

## Purpose

Defines the implementation contract for `Subscription_Catalog_Entitlements`. This contract is based on
...
| API Group | Purpose |
|---|---|
| `/api/v1/platform/subscription-plans` | Module API group |
| `/api/v1/platform/subscription-addons` | Module API group |
| `/api/v1/platform/features` | Module API group |
| `/api/v1/platform/entitlements` | Module API group |
...
- [[04_MODULE_KNOWLEDGE/03_Subscription_Catalog_Entitlements/01_Module_Overview]]
