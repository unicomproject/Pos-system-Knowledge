<!-- title: Product Technical Contract -->
<!-- status: Active -->
...
This file defines the technical contract for the `Product` module.

## API Contract

| Area | Contract |
|---|---|
| API group | `/api/v1/products, /api/v1/categories, /api/v1/files` |
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Product/01_Module_Overview]]
