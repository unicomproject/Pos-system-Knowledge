<!-- title: Subscription Functional Rules -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Subscription Functional Rules

## Purpose

This file defines functional rules for the `Subscription` module.
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Subscription/01_Module_Overview]]
- [[99_Archive/04_MODULE_KNOWLEDGE/Subscription/03_Technical_Contract]]
