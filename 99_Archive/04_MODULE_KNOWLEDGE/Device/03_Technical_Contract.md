<!-- title: Device Technical Contract -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Device Technical Contract

## Purpose

This file defines the technical contract for the `Device` module.

## API Contract

| Area | Contract |
|---|---|
| API group | `/api/v1/devices, /api/v1/tills` |
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Device/01_Module_Overview]]
- [[99_Archive/04_MODULE_KNOWLEDGE/Device/02_Functional_Rules]]
