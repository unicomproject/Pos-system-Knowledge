<!-- title: Device Functional Rules -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Device Functional Rules

## Purpose

This file defines functional rules for the `Device` module.
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Device/03_Technical_Contract]]
