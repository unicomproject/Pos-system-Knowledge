<!-- title: Inventory Technical Contract -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Inventory Technical Contract

## Purpose

This file defines the technical contract for the `Inventory` module.

## API Contract

| Area | Contract |
|---|---|
| API group | `/api/v1/inventory` |
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Inventory/01_Module_Overview]]
- [[99_Archive/04_MODULE_KNOWLEDGE/Inventory/02_Functional_Rules]]
