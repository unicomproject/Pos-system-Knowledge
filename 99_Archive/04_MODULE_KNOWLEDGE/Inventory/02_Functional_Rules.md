<!-- title: Inventory Functional Rules -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Inventory Functional Rules

## Purpose

This file defines functional rules for the `Inventory` module.
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Inventory/03_Technical_Contract]]
