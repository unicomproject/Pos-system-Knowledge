<!-- title: Return_Refund Technical Contract -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Return_Refund Technical Contract

## Purpose

This file defines the technical contract for the `Return_Refund` module.

## API Contract

| Area | Contract |
|---|---|
| API group | `/api/v1/pos/returns, /api/v1/pos/refunds` |
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Return_Refund/01_Module_Overview]]
