<!-- title: Discount Functional Rules -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Discount Functional Rules

## Purpose

This file defines functional rules for the `Discount` module.
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Discount/03_Technical_Contract]]
