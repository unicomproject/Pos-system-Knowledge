<!-- title: Tenant Functional Rules -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Tenant Functional Rules

## Purpose

This file defines functional rules for the `Tenant` module.
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Tenant/01_Module_Overview]]
