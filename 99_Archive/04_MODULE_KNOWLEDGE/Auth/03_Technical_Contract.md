<!-- title: Auth Technical Contract -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Auth Technical Contract

## Purpose

This file defines the technical contract for the `Auth` module.
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Auth/01_Module_Overview]]
