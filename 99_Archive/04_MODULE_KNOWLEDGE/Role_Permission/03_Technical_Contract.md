...
# Role_Permission Technical Contract

## Purpose

This file defines the technical contract for the `Role_Permission` module.

## API Contract

| Area | Contract |
|---|---|
| API group | `/api/v1/roles, /api/v1/permissions, /api/v1/features` |
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Role_Permission/01_Module_Overview]]
