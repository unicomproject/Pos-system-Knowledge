<!-- title: Sales Functional Rules -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Sales Functional Rules

## Purpose

This file defines functional rules for the `Sales` module.
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Sales/03_Technical_Contract]]
