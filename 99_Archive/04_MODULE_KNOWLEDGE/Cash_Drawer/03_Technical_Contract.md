<!-- title: Cash_Drawer Technical Contract -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Cash_Drawer Technical Contract

## Purpose

This file defines the technical contract for the `Cash_Drawer` module.

## API Contract

| Area | Contract |
|---|---|
| API group | `/api/v1/tills and POS cash movement API group` |
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Cash_Drawer/01_Module_Overview]]
