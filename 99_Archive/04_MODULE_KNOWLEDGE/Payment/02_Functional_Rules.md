<!-- title: Payment Functional Rules -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Payment Functional Rules

## Purpose

This file defines functional rules for the `Payment` module.
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Payment/03_Technical_Contract]]
