<!-- title: Payment Technical Contract -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Payment Technical Contract

## Purpose

This file defines the technical contract for the `Payment` module.

## API Contract

| Area | Contract |
|---|---|
| API group | `/api/v1/pos/payments, /api/v1/pos/receipts` |
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Payment/01_Module_Overview]]
- [[99_Archive/04_MODULE_KNOWLEDGE/Payment/02_Functional_Rules]]
