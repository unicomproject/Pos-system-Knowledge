<!-- title: Till Module Overview -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Till Module Overview

## Purpose

Manage tills, activation codes and till sessions.
...
| Frontend surfaces | Platform Admin setup; Tenant Admin till management; Cashier open/close. |
| Backend API group | `/api/v1/tills` |
...
Till code is tenant/outlet unique; activation code is hash-only; one open session per till.
...
No offline till sync; no customer display.

## Related Files

- [[99_Archive/04_MODULE_KNOWLEDGE/Till/02_Functional_Rules]]
- [[99_Archive/04_MODULE_KNOWLEDGE/Till/03_Technical_Contract]]
