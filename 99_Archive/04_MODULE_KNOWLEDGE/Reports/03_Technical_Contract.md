<!-- title: Reports Technical Contract -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Reports Technical Contract

## Purpose

This file defines the technical contract for the `Reports` module.

## API Contract

| Area | Contract |
|---|---|
| API group | `/api/v1/reports` |
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Reports/02_Functional_Rules]]
