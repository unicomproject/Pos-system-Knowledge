<!-- title: Loyalty Technical Contract -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Loyalty Technical Contract

## Purpose

This file defines the technical contract for the `Loyalty` module.

## API Contract

| Area | Contract |
|---|---|
| API group | `/api/v1/loyalty, /api/v1/customers` |
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Loyalty/01_Module_Overview]]
