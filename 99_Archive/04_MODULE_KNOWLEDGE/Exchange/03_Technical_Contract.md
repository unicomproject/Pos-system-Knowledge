<!-- title: Exchange Technical Contract -->
<!-- status: Active -->
<!-- system: SCS-TIX EPOS Release 1 -->
<!-- last_updated: 2026-06-08 -->


# Exchange Technical Contract

## Purpose

This file defines the technical contract for the `Exchange` module.

## API Contract

| Area | Contract |
|---|---|
| API group | `/api/v1/pos/exchanges` |
...
- [[99_Archive/04_MODULE_KNOWLEDGE/Exchange/01_Module_Overview]]
