<!-- title: Tenant Admin Add Product — 8-Step Wizard Flutter Implementation Specification -->
<!-- status: Active -->
<!-- system: OneVerz POS Flutter Client Scope -->
<!-- last_updated: 2026-08-11 -->

# Tenant Admin Add Product — 8-Step Wizard Flutter Implementation Specification

## 1. Executive Overview

This document specifies the canonical Flutter architecture, Riverpod state management, widget hierarchy, DTO mapping, and business rule enforcement for the **Tenant Admin Add Product Wizard** (8-step layout).
