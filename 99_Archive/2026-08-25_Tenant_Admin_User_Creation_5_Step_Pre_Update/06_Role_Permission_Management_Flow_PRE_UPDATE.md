...
Authenticated validation found 44 active Cashier grants with no matching
catalog entries. The production edit journey is `BLOCKED` until catalog, seed,
entitlement, and delegation projections are reconciled. This addendum
supersedes the stale missing-controller row in the implementation table.
