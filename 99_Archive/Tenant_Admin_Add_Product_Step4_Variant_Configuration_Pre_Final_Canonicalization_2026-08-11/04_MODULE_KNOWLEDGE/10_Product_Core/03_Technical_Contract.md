...
| `product_variants` | Stores sellable variant details, SKU, and barcode links for VARIANT products. |
| `product_unit_settings` | Stores product-specific unit model, UOM selections, multipliers, and decimal settings. |
| `product_unit_conversions` | Stores pre-calculated conversion factors to Base Unit for active unit levels. |
