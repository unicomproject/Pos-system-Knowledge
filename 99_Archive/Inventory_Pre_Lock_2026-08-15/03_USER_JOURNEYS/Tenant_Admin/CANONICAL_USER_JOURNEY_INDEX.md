...
| TA-UJ-017 | Add User | COMPLETE | 90 |
...
Prototype grouping IDs `INV-UJ-01` … `INV-UJ-05` do **not** replace canonical `TA-UJ-*` IDs. Journey implementation status above remains NOT_STARTED until production implementation.
