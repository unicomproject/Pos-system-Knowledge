OV.Icon = function(name){
  ...
  const i={
    ...
    edit:`<svg ${base}><path d="M4 20h4l10-10-4-4L4 16v4Z"/><path d="m12 8 4 4"/></svg>`,
...
OV.ProductArt = function(type){
  if(type==="jersey"){
    return `<svg viewBox="0 0 100 90"><rect width="100" height="90" rx="10" fill="#EEF5FF"/><path d="M30 15 42 10h16l12 5 16 12-10 15-9-6v40H33V36l-9 6-10-15 16-12Z" fill="#86C8F2"/><text x="50" y="34" text-anchor="middle" font-size="7" fill="#194C83">HAALAND</text><text x="50" y="54" text-anchor="middle" font-size="22" font-weight="700" fill="#194C83">9</text></svg>`;
  }
  if(type==="shirt"){
    return `<svg viewBox="0 0 100 90"><rect width="100" height="90" rx="10" fill="#F2F4F7"/><path d="M29 15 42 10h16l13 5 15 14-12 15-8-6v38H34V38l-8 6-12-15 15-14Z" fill="#111827"/><circle cx="50" cy="44" r="12" fill="#64748B"/><circle cx="50" cy="44" r="8" fill="#1F2937"/></svg>`;
  }
