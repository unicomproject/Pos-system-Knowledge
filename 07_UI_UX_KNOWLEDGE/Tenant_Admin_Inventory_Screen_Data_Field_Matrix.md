...
**DTO / ATTRIBUTE MAPPING: LOCKED.** Future implementation must not invent fields without a documented Inventory change request.
...
Canonical lock: [[Tenant_Admin_Inventory_Lock_Manifest]]
